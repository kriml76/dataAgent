...
(2, '数据仓库PostgreSQL', 'postgresql', 'localhost', 5433, 'data_warehouse', 'postgres', 'admin123456', 'jdbc:postgresql://localhost:5433/data_warehouse', 'inactive', 'unknown', '本地PostgreSQL数据仓库，用于数据分析和报表生成', 2100246635, NOW(), NOW());
